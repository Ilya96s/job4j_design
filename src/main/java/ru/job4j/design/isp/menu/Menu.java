 ...
 * Menu
 *
 * Дерево строится на основе MenuItem, но добавление делается по независимым данным от MenuItem
 * Данные меню возвращаются в виде другого объекта. Например MenuItemInfo
 */
public interface Menu extends Iterable<Menu.MenuItemInfo> {
    ...
    /**
     * Данные меню возвращаем в виде другого объекта MenuItemInfo
     */
    class MenuItemInfo {
